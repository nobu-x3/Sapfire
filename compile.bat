cmake -B build -DCMAKE_BUILD_TYPE=Debug -G Ninja -DCMAKE_CXX_COMPILER="C:/Program Files/LLVM/bin/clang++.exe" -DCMAKE_C_COMPILER="C:/Program Files/LLVM/bin/clang.exe" -Wdeprecated-declarations -DROOT_PATH_ABS=%cd% -DDIRECTX_DXC_TOOL=%cd%/engine/vendor/dxc/_bin/x64/dxc.exe
cd build
:: ninja Shaders
ninja
cd ..
...
xcopy /S /I /H /Q /Y build\vendor\dxc\lib\x64\dxcompiler.pdb bin
xcopy /S /I /H /Q /Y build\engine\vendor\dxc\lib\x64\dxcompiler.dll bin
xcopy /S /I /H /Q /Y engine\vendor\dxc\_bin\x64\dxil.dll bin
xcopy /S /I /H /Q /Y engine\vendor\dxc\_bin\x64\dxil.pdb bin
