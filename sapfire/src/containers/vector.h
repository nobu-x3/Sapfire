...
#define vector_pop_at(vector_ptr, index, val_ptr) _vector_pop_at(vector_ptr, index, val_ptr)
#define vector_clear(vector_ptr) _vector_field_set(vector_ptr, VECTOR_LENGTH, 0)
#define vector_len(vector_ptr) _vector_field_get(vector_ptr, VECTOR_LENGTH)
#define vector_capacity(vector_ptr) _vector_field_get(vector_ptr, VECTOR_CAPACITY)
#define vector_stride(vector_ptr) _vector_field_get(vector_ptr, VECTOR_STRIDE)
#define vector_set_length(vector_ptr, length) _vector_field_set(vector_ptr, VECTOR_LENGTH, length)
